...
define("DB_HOST", 'host');
define("BACKUP_DIR", 'rutaDeAlmacenamiento'); // Comment this line to use same script's directory ('.')
        ...
        try {
            ...
            */
            foreach($tables as $table) {
                $this->obfPrint("Respaldando `".$table."` tabla...".str_repeat('.', 50-strlen($table)), 0, 0);
                /**
                 * CREATE TABLE
                 */
    ...
    protected function gzipBackupFile($level = 9) 
      {
        ...
        $dest =  $source . '.gz';
        $this->obfPrint('Respaldo guardado en:  ' . $dest . '... ', 1, 0);
        $mode = 'wb' . $level;
